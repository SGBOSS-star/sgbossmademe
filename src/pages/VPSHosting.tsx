    ...
    <div className="py-8 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 md:mb-16">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4">VPS Plans</h2>
            <p className="text-lg text-gray-400">
              All VPS plans are powered by the high-performance <span className="font-bold">AMD Ryzen™ 7 7700</span> processor
            </p>
          </motion.div>
          <motion.div 
          ...
          >
            ...
            >
              <div className="p-4 md:p-6">
                ...
                <div className="mb-4">
                  <span className="text-2xl md:text-3xl font-bold text-purple-400">$7.50</span>
                  <span className="text-gray-400">/month</span>
                </div>
                <ul className="space-y-3 mb-6">
            ...
            >
              <div className="p-4 md:p-6">
                ...
                <div className="mb-4">
                  <span className="text-2xl md:text-3xl font-bold text-purple-400">$17.50</span>
                  <span className="text-gray-400">/month</span>
                </div>
                <ul className="space-y-3 mb-6">
